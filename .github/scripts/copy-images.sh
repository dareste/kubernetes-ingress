...
## useful commands:
## AWS Marketplace - 709825985650.dkr.ecr.us-east-1.amazonaws.com
...
## GCR private registry & Marketplace - gcr.io/f5-gcs-7899-ptg-ingrss-ctlr &
# gcloud auth configure-docker gcr.io
##  NGINX registry - docker-mgmt.nginx.com
# JWT Token from https://access-token.nginx.com
# skopeo login --username <jwt> --password-stdin <email>
